        ...
        <div id="poststuff" class="metabox-holder ppw-settings">
			...
			<div class="postbox" id="ppw_instructions">
				...
				<?php
					...
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;// If you omit this line, codes will be added to all your pages and caching will be disabled. So it is recommended to keep and modify it for the pages you are using.<br />
